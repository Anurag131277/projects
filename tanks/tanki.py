...
def game_over():
    ...
    while game_over:
        ...
        message_to_screen("You Died!",black,
                          -30)
...
def you_win():
    ...
    while game_over:
        ...
        message_to_screen("Congratulations!",black,
                          -30)
